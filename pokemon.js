    ...
    function displayPokemons(pokemon) {
        ...
        pokemon.forEach((pokemon) => {
            ...
            listItem.innerHTML = `
                ...
                <div class="img-wrap">
                    <img src="https://raw.githubusercontent.com/pokeapi/sprites/master/sprites/pokemon/other/dream-world/${pokemonID}.svg" alt="${capitalizedPokemonName} />
                </div>
                <div class="name-wrap">
                    <p class="body3-fonts">${capitalizedPokemonName}</p>
                </div>
            `;
